...
<add a couple of sentences about software metadata / documentation > For software to be findable it must first be documented, providing essential information in an ideally machine-readable and certainly human-accessible form.  Facilitate the discoverability of the open source software projects by registering metadata related to the software, including information like the source code location, contributors, and license, in a popular community registry, making your source code more discoverable. Metadata registration:
