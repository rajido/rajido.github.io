...
* Federico López Gómez - ELIXIR Hub, Wellcome Genome Campus, Hinxton, CB10 1SD, UK.

* José Luis Oliveira, University of Aveiro, DETI/IEETA, ORCID:	0000-0002-6672-6176
...
Our target audience includes leaders and managers of organisations and projects, journal editorial bodies, as well as funding agencies concerned with the provision of products and services that rely on the development of open research software. We want to provide these stakeholders with a simple approach to drive, incentivise, and support the development of better software. Though these OSS recommendations have mostly been developed within, and received feedback from, the life science community, the document and its recommendations generally apply to all research fields.

Strategies to increase software quality usually target software developers, focusing on training and adoption of best practices [(Wilson et al. 2014)](https://paperpile.com/c/InAwES/v1X7). This approach can yield good results, but requires a significant effort as well as personal commitment from developers [(Wilson 2014)](https://paperpile.com/c/InAwES/1XuR). For an organisation employing researchers and developers with a set of different programming skills and responsibilities it is not easy to endorse specific best practices or define a broad range of training needs. It is easier to endorse a set of basic recommendations that are simple to monitor, simple to comply with, and will drive the adoption of best practices and reveal training needs. The OSS recommendations aim to create awareness, encouraging developers to be more conscious of the extent to which they are complying with best practices, and making them more willing to collaborate and request support if needed. In other words, they define a path but still give developers freedom to choose how to implement best practices.

We encourage organisations, projects, journals, as well as funding agencies to adopt the OSS recommendations. We see endorsement as the first step: that is, agreeing to support the OSS recommendations without a formal process for implementation. Promotion is a second step: that is, actively publicising and incentivising the OSS recommendations within the organisation as well as globally. Compliance is the third step: to formally implement them within the organisation, with ongoing monitoring and public reporting if possible. To facilitate progress, we propose that organisations, projects, journals, as well as funding agencies include these OSS recommendations as part of their policies related to the development and publication of software.

Open Source Software is not just adopted by non-profit organisations but many commercial companies as a business model [(Popp 2015)](https://paperpile.com/c/InAwES/Mw6t), so we encourage not just public funded projects but for profit entities to adopt OSS and support these recommendations.

## Contributions

The OSS recommendations have been developed by a wide range of stakeholders who are concerned with the production of quality software for research. For further information, development, endoremsent and comments of the OSS recommendations please visit the following site: [https://github.com/](https://github.com/SoftDev4LS/open-source-software)[SoftDev4LS](https://github.com/SoftDev4LS/open-source-software)[/open-source-software](https://github.com/SoftDev4LS/open-source-software) 
...
Some common doubts and questions about making software Open Source are discussed in the attached appendix, "[Fears of open-sourcing your software project](https://docs.google.com/document/d/1EvhqaDlC1u2iVfqGv-lvPGOgTM5Gc0zRbe70OhaBcqM/edit?usp=sharing)".
...
We advise choosing a [OSI-approved Open Source License](https://opensource.org/licenses) following these [guidelines](http://choosealicense.com/) unless your institution or project requires a different license. For reusability reasons, authors should disclose any patents and pending patent applications known to them affecting the software.
...
The FAIR Guiding Principles for scientific data management and stewardship provide recommendations on how to make research data findable, accessible, interoperable and reusable (FAIR) (Wilkinson et al. 2016). While the FAIR data principles were originally designed for data, they are sufficiently general that the high level concepts can be applied to software. Though not all the recommendations from the FAIR data principles apply to software there is a good alignment between the OSS recommendations and the FAIR data principles. For instance: "Make software easy to discover by providing software metadata via a popular community registry" do align with the Findable principle helping to increase visibility and helping software providers to think about how to describe software metadata. “Develop publicly accessible open source code from day one” do align with the Accessible principle highlighting how to make the source code open and publicly available. “Adopt a license and comply with the licence of third-party dependencies” do align with the interoperable and reusable principles helping to define how the source code can be used and reused by the community and how it can be used as part of other software.

Besides the obvious difference between data and software there are also some distinctions between the OSS recommendations and the FAIR data principles. The FAIR data principles have a specific emphasis on enhancing the ability of machines to automatically find and use the data. The OSS recommendations instead aims to encourage and think about the adoption of best practices. The FAIR data principles also describe fifteen recommendations while the OSS recommendations focus on four. At the moment not all the fifteen FAIR data recommendations are easy to validate while the OSS recommendations were designed to be measured and validated without much effort.

# Conclusion

The OSS recommendations aim to positively impact the adoption of best practices and thus help to develop better and more sustainable software. These recommendations are designed around practical suggestions of how to make research software and its source code more accessible, discoverable, reusable and transparent following Open Source values.  Unlike many software development best practices tailored for software developers, the OSS recommendations aim to target a wider audience, particularly research funders, research institutions, journals, group leaders, and managers of projects producing research software. We encourage organisations and projects to adopt the OSS recommendations and include them as part of their policies to facilitate the process of adoption. The adoption of these recommendations give the developers a justified reason to spend time to write software following best practices and helps the community to exploit collaborations from an early stage of the project. Due to their simplicity and low barrier implementation, we would like to see many projects and organisations joining to this initiative.
...
[DagstuhlEAS. 2017. "DagstuhlEAS/draft-Manifesto." ](http://paperpile.com/b/InAwES/LeOo)*[GitHu*b](http://paperpile.com/b/InAwES/LeOo)[. Accessed January 5. ](http://paperpile.com/b/InAwES/LeOo)[https://github.com/DagstuhlEAS/draft-manifesto](https://github.com/DagstuhlEAS/draft-manifesto)[.](http://paperpile.com/b/InAwES/LeOo)
...
["[No Title]." 2017a. Accessed January 4. ](http://paperpile.com/b/InAwES/rCHo)[https://icerm.brown.edu/tw12-5-rcem/icerm_report.pdf](https://icerm.brown.edu/tw12-5-rcem/icerm_report.pdf)[.](http://paperpile.com/b/InAwES/rCHo)

[———. 2017b. Accessed January 5. ](http://paperpile.com/b/InAwES/DejD)[https://hal.inria.fr/hal-01367344/document](https://hal.inria.fr/hal-01367344/document)[.](http://paperpile.com/b/InAwES/DejD)
...
[Smith, Arfon M., Daniel S. Katz, Kyle E. Niemeyer, and FORCE11 Software Citation Working Group. 2016. "Software Citation Principles." ](http://paperpile.com/b/InAwES/1rXc)*[PeerJ Computer Scienc*e](http://paperpile.com/b/InAwES/1rXc)[ 2: e86.](http://paperpile.com/b/InAwES/1rXc)
...
* Issue No. 01 - January/February (2009 vol. 11) [https://www.computer.org/csdl/mags/cs/2009/01/mcs2009010035-abs.html](https://www.computer.org/csdl/mags/cs/2009/01/mcs2009010035-abs.html)

* "Enabling Reproducible Research: Open Licensing For Scientific Innovation", International Journal of Communications Law and Policy, Issue 13, 2009. [http://stanford.edu/~vcs/papers/Legal-STODDEN2009.pdf](http://stanford.edu/~vcs/papers/Legal-STODDEN2009.pdf)

* "What Computational Scientists Need to Know About Intellectual Property Law: A Primer," chapter in Stodden, V., Leisch, F., and Peng, R. (eds). 2014. Implementing Reproducible Computational Research. Boca Raton: Chapman & Hall/CRC), also available here: [https://osf.io/yi8k2/](https://osf.io/yi8k2/) .

* Fehr et al. Best practices for replicability, reproducibility and reusability of computer-based experiments exemplified by model reduction software. http://www.aimspress.com/fileOther/PDF/Math/Math-03-00261.pdf
...
* José Luis Oliveira: The first idea is related to identifying "what is the software for", because finding the "best" software for a problem may be not solved just through metadata. This deals with identifying the audience, the problem(s), the current tools, and how this new software fits the solution. This will not influence directly the choice for OSS, but would help to give more visibility and trust.

* José Luis Oliveira: The second, is related to benchmarking, i.e. how can a potential user/developer measure the quality of a particular OSS. This is a tricky issue but several characteristics could be enumerated such as users adherence, developers community, publications, "OSS index", ...
